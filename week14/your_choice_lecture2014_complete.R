...
#Write detailed comments in your scripts! You NEVER want to look back at a script and not know why you ran your analysis a certain way, removed a participant, or used a certain function.
...
#2. Read in the data
#read in data
m=read.csv("~/Dropbox/Classes/R course/lesson_plans/class_12_04_14/memory_mood_data.csv")
...
#create new column
m$positive_affect_group=rep("0",dim(m)[1])
#fill in new column based on the positive_affect criteria
...
#Read in data
w=read.csv("~/Dropbox/Classes/R course/lesson_plans/class_12_04_14/within_subjects_anova.csv")
head(w)
str(w)
