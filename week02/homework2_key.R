...
well_adjusted = mood[mood$happy>3 & mood$stress<3,]
...
mood[mood$stress>2 & (mood$happy<= 2 | mood$excited<3),]
...
mood$positive_mood = mood$happy * mood$excited
...
mood$mood_score = (mood$happy + mood$excited) - mood$stress
