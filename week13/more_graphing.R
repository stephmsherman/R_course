...
barplot2(m,xlab="Level of Test Difficulty", ylab="Test Score",plot.ci=TRUE, ci.l=lower_bar, ci.u=upper_bar, las=1, col=c("orange red", "red2","red3","red4","dark red"), ci.col="blue", ci.lwd=2, ci.width=.2)
